'''
Задание 12. Обработка строки чисел с ведущей стрелочкой. (ЕГЭ -  23912)
Решение использует функцию find (встроена в search).

! Написание отдельной функции необязательно !
'''
...
def main():
    s = ">"  # Строка с указателем, которую мы будем заполнять числами
